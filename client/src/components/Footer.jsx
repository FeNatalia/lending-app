          ...
          <form action="">
            <div className="grid md:grid-cols-3 gird-cols-1 gap-4 justify-center items-center">
              ...
              <div className="md:mr-auto mb-6">
                <button
                  type="submit"
                  className="inline-block px-6 py-2 bg-red-600 border-2 border-white text-white font-medium text-xs leading-tight uppercase rounded hover:bg-red-800 focus:outline-none focus:ring-0 transition duration-150 ease-in-out"
                >
                  Subscribe
                </button>
              </div>
